...
@Alias("doodles")
public class Doodles extends DefaultDomain {
	private String url;
    
	private String site_Name;
	private String KDesc;
	private String doodlesId;
	...
	public String[] chkDoodlesIds = null;			//체크 SiteId - 다중삭제용
	...
	public String makeDataString(){
		...
		sbData
			...
			.append(">> DoodlesId   : ").append(this.getDoodlesId())    .append("\n")
	...
	public String makeDMLDataString(){
		//InDMLData ::  SiteID|DoodlesID|KName|ImageFileName|ImageSFileNmae|FilePath|LinkURL|Sort|StratTime|EndTime|NewWindowYn|State
		StringBuffer sbData = new StringBuffer();
		
		sbData
			.append(StringUtil.getString(this.getSiteId(), "-"))	    .append("|")
			.append(StringUtil.getString(this.getDoodlesId(), ""))	.append("|")
	...
	public String getDoodlesId() {
		return doodlesId;
	}
	public void setDoodlesId(String doodlesId) {
		this.doodlesId = doodlesId;
	}
	...
	public String[] getChkDoodlesIds() {
		return chkDoodlesIds;
	}

	public void setChkDoodlesIds(String[] chkDoodlesIds) {
		this.chkDoodlesIds = chkDoodlesIds;
	}
