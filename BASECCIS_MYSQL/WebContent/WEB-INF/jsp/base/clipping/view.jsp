...
<article class="news_view">
	...
	<dl class="info">
        ...
        <tr>
            ...
            <td colspan="3">
            	<a href="${contextPath}/fileDownload?titleId=${rtnContent.TITLEID }&fileDownType=C&paramMenuId=${obj.menuId}" alt="${rtnContent.ALTINFO }"><c:out value="${rtnContent.IMAGEFILENAME }" /></a>
            </td>
        </tr> 
        </c:if> --%>
	</dl>
