...
<div class="btn_area">
	<%-- 
		<button type="button" id="btnEvent" class="btn btn_type02">${eventId > 0 ? '행사상세' : '행사등록' }</button>
	--%>	
...
$(window).load(function(){
	// SNS 공유하기
	var urlFaceBook = "http://www.facebook.com/sharer.php?u=" + encodeURIComponent("http://www.khidi.or.kr/board/view?menuId=${obj.menuId}&linkId=${obj.linkId }");
	var urlTwitter = "http://twitter.com/share?status=" + encodeURIComponent("http://www.khidi.or.kr/board/view?menuId=${obj.menuId}&linkId=${obj.linkId }");
