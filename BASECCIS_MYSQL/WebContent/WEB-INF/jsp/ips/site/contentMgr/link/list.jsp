...
<spform:form id="listForm" name="listForm" action="${contextPath }/mgr/contentMgr/actLinkBoard" method="POST">
	...
	<div class="table">
	    <table class="tstyle_list">
	        ...
	        <c:choose>          
	            ...
	            <c:otherwise>
	            <tr>
	                <td colspan="${rtnSetting.categoryYN == 'Y' ? 7 : 6}">조회된 데이터가 없습니다.</td>
	            </tr>
	            </c:otherwise>
	        </c:choose>
	        </tbody>
...
$(function() {
    ...
    $('#btnAdd').click(function(){
        document.location.href="${contextPath}/mgr/contentMgr/form?menuId=${obj.menuId}&boardKind=LINK";
    });
