...
<%@ include file="/includes/taglib.jsp" %>
    ...
    <!-- ▼ 등록페이지  -->
    <spform:form id="insertForm" name="insertForm" action="${contextPath }/mgr/contentMgr/actLinkBoard" method="post" >
        ...
        <fieldset>
            ...
            <table class="tstyle_view" summary="등록일, 이름, 이메일, 담당부서, 제목, 내용에 따른 게시물상세 안내">
                ...
                <tr>
                    ...
                    <th scope="row" rowspan="2"><span class="point01">*</span> <label for="temp_ocode">키워드</label></th>
                    <td rowspan="2">
                ...
                <tr>
                    <th scope="row"><label for="country">국가정보</label></th>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="contents1" name="contents1" maxlength="150" class="input_long" value="${rtnContent.CONTENTS1 }" /></td>
                </tr>
                </c:if>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="contents2" name="contents2" maxlength="150" class="input_long" value="${rtnContent.CONTENTS2 }" /></td>
                </tr>
                </c:if>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="contents3" name="contents3" maxlength="150" class="input_long" value="${rtnContent.CONTENTS3 }" /></td>
                </tr>
                </c:if>
                <!-- ▲ 추가 필드가 있을 시 -->                
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="linkUrl" name="linkUrl" class="input_long" value="${rtnContent.LINKURL }" /></td>                    
                </tr>
            </table>
        </fieldset>
    </spform:form>
...
$(function() {
	...
	$('#btnSave').click(function(){
		...
		// 유해어 검출 스크립트
 		...
 		$("#insertForm").attr('action', '${ctxMgr }/contentMgr/actLinkBoard');
		$("#insertForm").submit();
