...
<spform:form id="insertForm" name="insertForm" action="${contextPath }/mgr/contentMgr/actCardBoard" method="post" enctype="multipart/form-data">
...
$(function() {
	...
	$('#btnSave').click(function(){
		...
		// 유해어 검출 스크립트
 		...
 		$("#insertForm").attr('action', '${ctxMgr }/contentMgr/actCardBoard');
		$("#insertForm").submit();
