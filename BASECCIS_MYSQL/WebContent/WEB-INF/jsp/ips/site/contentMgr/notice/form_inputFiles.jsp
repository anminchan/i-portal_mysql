...
<%@ include file="/includes/taglib.jsp" %>
    ...
    <!-- ▼ 등록페이지  -->
    <spform:form id="insertForm" name="insertForm" action="${contextPath }/mgr/contentMgr/actNoticeBoard" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <table class="tstyle_view">
                ...
                <tr>
                    ...
                    <td>
                        <!-- 수정시 기본 선택 -->
                        <input type="radio" id="openY" name="openYN" value="Y" ${(empty(rtnContent.STARTTIME) or rtnContent.OPENYN == 'Y') ? 'checked="checked"' : ''} />
