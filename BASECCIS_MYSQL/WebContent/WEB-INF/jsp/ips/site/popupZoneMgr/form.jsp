...
<spform:form id="insertForm" name="insertForm" action="${contextPath }/mgr/popupZoneMgr/act" method="POST">
			...
			<table class="tstyle_view">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<c:if test="${!empty rtnPopupZone.imageFileName }">
								<ul class="download_list">
						        	<li><a href="${contextPath}/fileDownload?fileGubun=common&menuId=popupZoneMgr&userFileName=${rtnPopupZone.imageFileName }&systemFileName=${rtnPopupZone.imageSFileName }"><c:out value="${rtnPopupZone.imageFileName }" /> <span>내려받기</span></a></li>
								</ul>
							</c:if>
					        ...
					        <div id="flashContentManagerImages" style="display: none;">
					            ...
					            <script type="text/javascript"> 
					                ...
					                <c:if test="${!empty(rtnPopupZone.imageFileName)}">
	                             		...
	                             		strOldImgFileInfo.fileId = "${rtnPopupZone.popupZoneId}";
	                                    strOldImgFileInfo.fileName = "${rtnPopupZone.imageFileName}";
	                                    strOldImgFileInfo.fileSName = "${rtnPopupZone.imageSFileName}";
	                                    strOldImgFileInfo.filePath = "${rtnPopupZone.filePath}";
...
$(window).load(function(){
	...
	formaction = "${ctxMgr}/popupZoneMgr/act";
    filePath = "${contextPath}/namoFileUpload?fileGubun=common&fileMenuId=popupZoneMgr";
