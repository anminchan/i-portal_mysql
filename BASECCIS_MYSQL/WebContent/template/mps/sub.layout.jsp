...
<!-- 사이트별 css -->
<link rel="stylesheet" type="text/css" href="${contextPath }/resources/css/mps/basic.css" />
...
<div id="wrap">
	...
	<div id="visual">
		<strong class="eng"><img src="${contextPath}/resources/images/mps/layout/visual_txt.png" alt="The Bridge to Change"></strong>
	...
	<div id="body">
		...
		<!-- //content area -->		
    	<tiles:insertAttribute name="mps.content_footer" />
	</div>	
	<!-- //Body -->
    <hr/>    
    <!-- footer Area -->
