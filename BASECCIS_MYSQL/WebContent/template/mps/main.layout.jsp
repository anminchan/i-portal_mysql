...
<title><tiles:insertAttribute name="mps.title" /></title>
	...
	<div id="layerPop${popupWindowList.POPUPID }" class="layerPop display_none" style="z-index:1000;position:absolute; top:${popupWindowList.POSITIONX }px; left:${popupWindowList.POSITIONY }px; width:${popupWindowList.POPUPWIDTH }px; height:${popupWindowList.POPUPHEIGHT+30}px;">
		<div class="layerPop_area">
			...
			<p class="close">
				...
				<span class="float_right"><a href="javascript:;" class="btnPopupWinodwClose" popupId="${popupWindowList.POPUPID }"><img src="${pageContext.request.contextPath}/resources/images/mps/main/popup_close.png" alt="닫기"/></a></span>
			</p>
		</div>
	</div>
</c:forEach>
...
<div id="wrap">
	<header id="header">
		<tiles:insertAttribute name="mps.header.top" />
		<tiles:insertAttribute name="mps.header.nav" />
	</header>
	<hr/>
	<div id="body">
    	<tiles:insertAttribute name="mps.body" />    	
	</div>
	<!-- //Body -->
    <hr/>    
    <!-- footer Area -->
    <tiles:insertAttribute name="mps.footer" />
    <!-- //footer Area -->
</div>
<!-- //wrap -->
</body>
